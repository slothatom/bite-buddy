...
const SPECS: DishSpec[] = [
  ...
  },
  {
    ...
    aliases: ['ciorba de fasole verde', 'supa de fasole verde', 'supa fasole verde',
      'zoldpaszuly leves', 'zoldbableves'],
    byWeight: true,
  },
  {
    id: 'dish-soup-noodle', en: 'Noodle soup', ro: 'supă de tăiței', hu: 'tyúkhúsleves', emoji: '🍜',
    servings: 4, parts: [['chicken-breast', 200], ['pasta-wholemeal', 80], ['carrot', 150],
      ['celeriac', 80], ['onion', 60], ['water', 1400]],
    tags: ['soup', 'batch'], prep: 15, cook: 40,
    steps: ['Simmer the chicken with the vegetables until it gives.', 'Cook the noodles in the strained broth.'],
    aliases: ['supa de taitei', 'supa de taietei', 'tyukhusleves'],
    byWeight: true,
  },
  {
    id: 'dish-ciorba-chicken', en: 'Chicken sour soup', ro: 'ciorbă de pui',
    hu: 'csirkés csorba', emoji: '🍲',
    servings: 2, parts: [['chicken-breast', 120], ['rice-white', 30], ['carrot', 80],
      ['celeriac', 50], ['onion', 50], ['olive-oil', 10], ['water', 600]],
    tags: ['soup', 'batch', 'high-protein'], prep: 15, cook: 30,
    steps: ['Simmer the chicken with the vegetables and the rice.', 'Sour to taste before serving.'],
    aliases: ['csirkes csorba', 'ciorba de pui'],
    byWeight: true,
  },
  {
  ...
  {
    id: 'dish-soup-pumpkin-cream', en: 'Cream of pumpkin soup', ro: 'supă cremă de dovleac',
    hu: 'sütőtökkrémleves', emoji: '🎃',
    servings: 2, parts: [['pumpkin', 600], ['carrot', 80], ['onion', 60], ['butter', 10], ['water', 500]],
    tags: ['soup', 'vegetarian', 'batch'], prep: 12, cook: 25,
    steps: ['Soften the onion and carrot in the butter.', 'Add the pumpkin and water, simmer until tender, then blend.'],
    aliases: ['supa crema de dovleac', 'sutotokkremleves', 'supa de dovleac'],
    byWeight: true,
  },
  {
    id: 'dish-squash-stew', en: 'Squash stew', ro: 'tocană de dovlecel', hu: 'tökfőzelék', emoji: '🥘',
    // A főzelék is a thickened vegetable stew, eaten as the main part of a
    // meal rather than as a side, which is why it is portioned by weight.
    servings: 2, parts: [['zucchini', 700], ['onion', 60], ['olive-oil', 15], ['flour-wheat', 10], ['yogurt', 60]],
    tags: ['vegetarian', 'batch'], prep: 10, cook: 25,
    steps: ['Sweat the onion in the oil and add the grated squash.', 'Thicken with the flour, finish off the heat with the yogurt.'],
    aliases: ['tokfozelek', 'tocana de dovlecel'],
    byWeight: true,
  },
  {
    id: 'dish-ciorba-meatball', en: 'Meatball sour soup', ro: 'ciorbă de perișoare', emoji: '🥣',
    servings: 4, parts: [['beef', 200], ['rice-white', 40], ['carrot', 120], ['onion', 80],
      ['celeriac', 60], ['tomato-sauce', 80], ['olive-oil', 20], ['water', 1200]],
    tags: ['soup', 'batch'], prep: 20, cook: 40,
    steps: ['Roll the mince with the rice into small meatballs.', 'Simmer with the vegetables, then sour to taste.'],
    aliases: ['ciorba de perisoare', 'ciorba perisoare'],
    byWeight: true,
  },
  {
    id: 'dish-pumpkin-muffins', en: 'Pumpkin muffins', ro: 'brioșe cu dovleac', emoji: '🧁',
    servings: 6, parts: [['pumpkin', 300], ['oats', 120], ['egg', 110], ['yogurt', 100],
      ['honey', 30], ['cinnamon', 3]],
    tags: ['batch', 'vegetarian'], prep: 15, cook: 25,
    steps: ['Blend everything to a batter.', 'Bake in a muffin tin until set.'],
    aliases: ['briose cu dovleac', 'brioșe cu dovleac'],
  },
  {
    id: 'dish-chicken-patties', en: 'Chicken patties', ro: 'chiftele de pui', hu: 'csirkés fasírt', emoji: '🍢',
    // Her own note on the line: half meat, half vegetable, bound with an egg.
    servings: 2, parts: [['chicken-breast', 150], ['vegetables-mixed', 150], ['egg', 55], ['olive-oil', 10]],
    tags: ['high-protein', 'batch'], prep: 15, cook: 20,
    steps: ['Mince the chicken with the grated vegetables and the egg.', 'Shape into patties and bake or pan-fry.'],
    aliases: ['csirkes fasirt', 'chiftele de pui'],
    byWeight: true,
  },
  {
    id: 'dish-korozott', en: 'Hungarian cheese spread', hu: 'körözött', emoji: '🧀',
    servings: 1, parts: [['cottage-cheese', 80], ['yogurt', 15], ['onion', 15], ['dill', 3]],
    tags: ['quick', 'vegetarian'], prep: 5, cook: 0,
    steps: ['Mash the curd cheese with the yogurt.', 'Fold through the finely chopped onion and dill.'],
    aliases: ['korozott', 'körözött'],
  },
  {
    id: 'dish-baked-sweet-potato', en: 'Baked sweet potato', ro: 'cartof dulce la cuptor',
    hu: 'édeskrumpli a sütőben', emoji: '🍠',
    servings: 1, parts: [['sweet-potato', 200], ['olive-oil', 5]],
    tags: ['quick', 'vegetarian'], prep: 5, cook: 40,
    steps: ['Bake whole until it gives to a squeeze.'],
    aliases: ['edeskrumpli a lerben', 'cartof dulce la cuptor'],
    byWeight: true,
  },
  {
    id: 'dish-baked-pumpkin', en: 'Baked pumpkin', ro: 'dovleac copt', hu: 'sült tök', emoji: '🎃',
    servings: 1, parts: [['pumpkin', 350], ['cinnamon', 2]],
    tags: ['quick', 'vegetarian'], prep: 5, cook: 35,
    steps: ['Bake in wedges until the edges caramelise.'],
    aliases: ['dovleac copt', 'dovleac la cuptor', 'dovleac placintar la cuptor', 'sult tok'],
    byWeight: true,
  },
