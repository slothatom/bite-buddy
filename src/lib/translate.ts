...
const PHRASES: Record<string, string> = {
  ...
  'gyumolcsos': 'fruit',
  'mexikoi': 'Mexican',
  'ket adaghoz': 'for two servings',
  'adaghoz': 'for a serving',
  'egy marek': 'a handful',
  ...
  'intr': 'in',
  'int': 'wholemeal',
  'zoldsegkremleves': 'cream of vegetable soup',
  'zellerkremleves': 'cream of celeriac soup',
  'kremleves': 'cream soup',
  'sarmalute': 'cabbage rolls',
  'feherrepa': 'parsnip',
  'telemeaval': 'with telemea',
  'taietei': 'noodles',
  'csorba': 'sour soup',
  'sandwich': 'sandwich',
  'fetas': 'feta',
